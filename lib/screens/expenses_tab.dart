...
class _ExpensesListTabState extends State<ExpensesListTab> {
  ...
  // Updated: Default can be 'Today' or 'Week'
    ...
    for (var expense in _expenses) {
      ...
      // --- Existing Logic ---
        ...
        if ((nDate.isAfter(nStart) || nDate.isAtSameMomentAs(nStart)) &&
            (nDate.isBefore(nEnd) || nDate.isAtSameMomentAs(nEnd))) {
          include = true;
        }
                        ...
                        child: Card(
                          ...
                          child: ListTile(
                            leading: CircleAvatar(
                              ...
                              child: const Icon(Icons.shopping_bag, color: Colors.redAccent),
                            ),
                            title: Text(
                              item.title,
